...
connector HeatPorts_b
  "HeatPort 配列用ポート（白抜き; ベクトル HeatPort の公開に使用）"
  ...
  annotation(
    ...
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-200, -50}, {200, 50}}, initialScale = 0.2), graphics = {
      ...
      Rectangle(extent = {{-170, 44}, {-82, -44}}, lineColor = {191, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid),
      Rectangle(extent = {{-44, 44}, {44, -44}}, lineColor = {191, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid),
      Rectangle(extent = {{82, 44}, {170, -44}}, lineColor = {191, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
...
<code>Modelica.Fluid.Interfaces.HeatPorts_b</code> と同様に、ドラッグ後に
配列次元を付けて使うことを想定した横長アイコンを持ちます。
</p>
<p>
物理的な変数は <code>HeatPort_b</code> と同じく <code>HeatPort</code> を継承した
