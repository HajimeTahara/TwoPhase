...
extends EAST.Icons.Convection;
  ...
  parameter Modelica.Units.SI.Length L = 0.1 "代表長さ [m]";
  parameter Modelica.Units.SI.Density rho = 1.2 "流体密度 [kg/m3]";
  parameter Modelica.Units.SI.DynamicViscosity mu = 1.8e-5 "流体の粘性係数 [Pa.s]";
  parameter Modelica.Units.SI.SpecificHeatCapacity cp = 1005 "流体の定圧比熱 [J/(kg.K)]";
  parameter Modelica.Units.SI.ThermalConductivity lambda = 0.026 "流体の熱伝導率 [W/(m.K)]";
