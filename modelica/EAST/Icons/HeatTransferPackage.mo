within EAST.Icons;
partial package HeatTransferPackage "MSL Modelica.Thermal.HeatTransfer パッケージのアイコン"
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
        ...
        Polygon(
          ...
          fillColor={191,0,0},
          fillPattern=FillPattern.Solid,
          points={{-17,-46},{-17,-34},{-40,-40},{-17,-46}})}), Documentation(info="<html>
<p>
MSL <code>Modelica.Thermal.HeatTransfer</code> パッケージ自体のアイコン
（2つの熱質量と熱流の矢印）を流用するための <code>partial package</code> です。
</p>
<p>
出典: Modelica.Thermal.HeatTransfer (Modelica Standard Library),
