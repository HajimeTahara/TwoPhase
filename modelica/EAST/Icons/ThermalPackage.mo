within EAST.Icons;
partial package ThermalPackage "MSL Modelica.Thermal パッケージのアイコン"
  ...
  annotation (Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}), graphics={
        ...
        Polygon(
          ...
          pattern=LinePattern.None,
          fillPattern=FillPattern.Solid,
          points={{0.0,21.667},{-10.0,-8.333},{10.0,-8.333}})}), Documentation(info="<html>
<p>
MSL <code>Modelica.Thermal</code> パッケージ自体のアイコンを流用するための
<code>partial package</code> です。
</p>
<p>
出典: Modelica.Thermal (Modelica Standard Library),
