...
model HeatCapacitor "体積と材料物性から熱容量を計算する集中熱容量"
  ...
  Thermal.HeatTransfer.Interfaces.HeatPort_a port_top "上側熱ポート"
    annotation (Placement(
      transformation(extent={{-10,90},{10,110}}),
      iconTransformation(extent={{-10,90},{10,110}})));
  Thermal.HeatTransfer.Interfaces.HeatPort_a port_right "右側熱ポート"
    annotation (Placement(
      transformation(extent={{90,-10},{110,10}}),
      iconTransformation(extent={{90,-10},{110,10}})));
  Thermal.HeatTransfer.Interfaces.HeatPort_a port_bottom "下側熱ポート"
    annotation (Placement(
      transformation(extent={{-10,-110},{10,-90}}),
      iconTransformation(extent={{-10,-110},{10,-90}})));
  Thermal.HeatTransfer.Interfaces.HeatPort_a port_left "左側熱ポート"
    annotation (Placement(
